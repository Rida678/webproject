...
<body>
    ...
    <main role="main" class="container">
      ...
      <div class="starter-template">
        <h1 class="text-center">Rida's Car Rental</h1>
        <p class="text-center">Welcome to the login page<br> If you don't have an account, click register to sign up right away!</p>
<div class="container">
